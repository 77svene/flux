...
from flux.data import get_dataset, get_template_and_fix_tokenizer
from flux.extras.constants import IGNORE_INDEX
from flux.extras.misc import get_device_count
from flux.extras.packages import is_vllm_available
from flux.hparams import get_infer_args
...
def vllm_infer(
    ...
    # The result matrix is referencing src.flux.train.sft.workflow.run_sft # 127~132
